...
![Screenshoot](docs/img/../assets/screencapture1.png)

Tampilkan ketika component text input diketikkan nama. Tampak component Text dibawahnya juga ikut berubah mengikuti text input.

![Screenshoot](docs/img/../assets/screencapture2.png)

Tampilkan ketika tombol **SUBMIT** ditekan. Tampak adanya popup yang berupa alert yang memunculkan text yang sesuai dengan yang diinputkan ke dalam text input.

![Screenshoot](docs/img/../assets/screencapture3.png)
